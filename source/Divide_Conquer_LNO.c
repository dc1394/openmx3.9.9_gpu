...
static double DC_NonCol(char * mode, int MD_iter, int SCF_iter, int SucceedReadingDMfile, double ***** Hks,
    ...
    ****************************************************/
    ...
    for (spin = 0; spin <= SpinP_switch; spin++) {
        ...
        for (Mc_AN = 0; Mc_AN <= Matomnum; Mc_AN++) {
            ...
            if (Max_Msize < Msize[Mc_AN])
                Max_Msize = Msize[Mc_AN];
        ...
        if (Spin_MPI_flag == 1) {
            ...
            if (myworld2_DCLNO == 0 && myid2 == 0) {
                ...
                for (h_AN = 0; h_AN <= FNAN[Gc_AN]; h_AN++) {
                    ...
                    for (i = 0; i < tno1; i++) {
                        for (j = 0; j < tno2; j++) {
                            ...
                            tmp_array[size1] = OLP0[Mc_AN][h_AN][i][j];
                            size1++;
                        }
                    }
                }

                MPI_Isend(&tmp_array[0], size1, MPI_DOUBLE, Comm_World_StartID2_DCLNO[1], tag,
                          MPI_CommWD1_DCLNO[myworld1_DCLNO], &request);
            }
                ...
                for (h_AN = 0; h_AN <= FNAN[Gc_AN]; h_AN++) {
                    ...
                    for (i = 0; i < tno1; i++) {
                        for (j = 0; j < tno2; j++) {
                            OLP0[Mc_AN][h_AN][i][j] = tmp_array2[size2];
                            size2++;
                        }
                    }
                }
...
#define H_ref(k, i, j) BLAS_H[k * NUM * NUM + (j - 1) * NUM + (i - 1)]
    ...
    SPIN_LOOP:
        ...
        ************************************************/
        ...
        if (Eigen_MPI_flag == 1) {
            ...
            BroadCast_ReMatrix(MPI_CommWD2_DCLNO[myworld2_DCLNO], C, NUM, is1, ie1, myid2, numprocs2, stat_send,
        ...
        */
        ...
        if (Eigen_MPI_flag == 1) {
            ...
            BroadCast_ReMatrix(MPI_CommWD2_DCLNO[myworld2_DCLNO], C, NUM, is2, ie2, myid2, numprocs2, stat_send,
                               request_send, request_recv);
        }
        ...
        ***********************************************/
        ...
        if (Eigen_MPI_flag == 0 || (Eigen_MPI_flag == 1 && myid2 == 0)) {
            ...
            ***********************************************/
            ...
            if ((TZ / 2 - 5) < LO_TC[spin][Mc_AN])
                LO_TC[spin][Mc_AN] -= 30;
            if (LO_TC[spin][Mc_AN] < 1)
                LO_TC[spin][Mc_AN] = 1;
            ...
            if (HO_TC[spin][Mc_AN] < (TZ / 2 + 5))
                HO_TC[spin][Mc_AN] += 30;
            if (NUM2 < HO_TC[spin][Mc_AN])
                HO_TC[spin][Mc_AN] = NUM2;
    ...
    if (Eigen_MPI_flag == 1 && myid1 != 0)
        Matomnum = 0;
    if (Eigen_MPI_flag == 1 && myid2 == 0)
        Matomnum = 1;
    ...
    SPIN_LOOP5:
        ...
        if (Spin_MPI_flag == 1) {
            ...
            if (myworld2_DCLNO == 1 && myid2 == 0) {
                ...
                for (h_AN = 0; h_AN <= FNAN[Gc_AN]; h_AN++) {
                    ...
                    for (i = 0; i < tno1; i++) {
                        for (j = 0; j < tno2; j++) {
                            ...
                            tmp_array[size1] = CDM_1[h_AN][i][j];
                            size1++;
                            tmp_array[size1] = EDM_1[h_AN][i][j];
                            size1++;
                        }
                    }
                }
                ...
                MPI_Recv(&tmp_array2[0], size2 * 2, MPI_DOUBLE, Comm_World_StartID2_DCLNO[1], tag,
                         MPI_CommWD1_DCLNO[myworld1_DCLNO], &stat);
                ...
                for (h_AN = 0; h_AN <= FNAN[Gc_AN]; h_AN++) {
                    ...
                    for (i = 0; i < tno1; i++) {
                        for (j = 0; j < tno2; j++) {
                            ...
                            CDM[1][Mc_AN][h_AN][i][j] = tmp_array2[size2];
                            size2++;
                            EDM[1][Mc_AN][h_AN][i][j] = tmp_array2[size2];
                            size2++;
                        }
                    }
                }
    ...
    if (measure_time) {
        printf("Divide_Conquer_LNO myid0=%2d NUM=%2d time0=%7.3f time1=%7.3f time2=%7.3f time3=%7.3f time4=%7.3f "
               "time5=%7.3f time6=%7.3f time7=%7.3f time8=%7.3f time9=%7.3f\n",
               myid0, NUM, time0, time1, time2, time3, time4, time5, time6, time7, time8, time9);
        fflush(stdout);
    }
...
#define HNC_ref(i, j)  BLAS_H[(j - 1) * NUM + (i - 1)]
        ...
        *****************************************************/
                                ...
                                for (m = 0; m < ian; m++) {
                                    for (n = 0; n < jan; n++) {
                                        ...
                                        */
                                        ...
                                        HNC_ref(Anum + m, Bnum + n + NUMH).r        = Hks[2][Mi][kl][m][n];
                                        HNC_ref(Anum + m, Bnum + n + NUMH).i =
                                            Hks[3][Mi][kl][m][n] + ImNL[2][Mi][kl][m][n];
                                        HNC_ref(Bnum + n + NUMH, Anum + m).r = HNC_ref(Anum + m, Bnum + n + NUMH).r;
                                        HNC_ref(Bnum + n + NUMH, Anum + m).i = -HNC_ref(Anum + m, Bnum + n + NUMH).i;
                                    }
                                }
                                ...
                                for (m = 0; m < ian; m++) {
                                    for (n = 0; n < jno; n++) {
                                        ...
                                        for (k = 0; k < jan; k++) {
                                            ...
                                            sumH01r += Hks[2][Mi][kl][m][k] * LNO_coes[0][Mj][n * jan + k];
                                            sumH01i += (Hks[3][Mi][kl][m][k] + ImNL[2][Mi][kl][m][k]) *
                                                       LNO_coes[0][Mj][n * jan + k];
                                        }
        ...
        if (Eigen_MPI_flag == 1) {
            ...
            if (myworld2_DCLNO == 0) {
                ...
                if (LNO_recalc_flag == 1) {
                    MPI_Bcast(&BLAS_OLP[0], NUM * NUM * sizeof(dcomplex), MPI_BYTE, 0,
                              MPI_CommWD2_DCLNO[myworld2_DCLNO]);
                }
            }
        ...
        ************************************************/
        ...
        if (0 < BN) {
            if (scf_eigen_lib_flag == CuSOLVER) {
                my_cublasZgemm(CUBLAS_OP_N, CUBLAS_OP_N, BM, BN, BK, &BLAS_H[0], &BLAS_OLP[(ns - 1) * NUM],
                               &BLAS_C[(ns - 1) * NUM]);
            } else {
                F77_NAME(zgemm, ZGEMM)
                ("N", "N", &BM, &BN, &BK, &ctmp1, &BLAS_H[0], &BM, &BLAS_OLP[(ns - 1) * NUM], &BK, &ctmp2,
                 &BLAS_C[(ns - 1) * NUM], &BM);
            }
        }
        ...
        if (0 < BN) {
            if (scf_eigen_lib_flag == CuSOLVER) {
                my_cublasZgemm(CUBLAS_OP_C, CUBLAS_OP_N, BM, BN, BK, &BLAS_OLP[0], &BLAS_C[(ns - 1) * NUM],
                               &BLAS_H[(ns - 1) * NUM]);
            } else {
                F77_NAME(zgemm, ZGEMM)
                ("C", "N", &BM, &BN, &BK, &ctmp1, &BLAS_OLP[0], &BM, &BLAS_C[(ns - 1) * NUM], &BK, &ctmp2,
                 &BLAS_H[(ns - 1) * NUM], &BM);
            }
        }
        ...
        */
        ...
        if (Eigen_MPI_flag == 1) {
            ...
            BroadCast_ComplexMatrix(MPI_CommWD2_DCLNO[myworld2_DCLNO], C, NUM, is1, ie1, myid2, numprocs2, stat_send,
                                    request_send, request_recv);
        }
        ...
        ***********************************************/
        ...
        if (0 < BN) {
            if (scf_eigen_lib_flag == CuSOLVER) {
                my_cublasZgemm(CUBLAS_OP_N, CUBLAS_OP_N, BM, BN, BK, &BLAS_OLP[0], &BLAS_H[(ns - 1) * NUM],
                               &BLAS_C[(ns - 1) * NUM]);
            } else {
                F77_NAME(zgemm, ZGEMM)
                ("N", "N", &BM, &BN, &BK, &ctmp1, &BLAS_OLP[0], &BM, &BLAS_H[(ns - 1) * NUM], &BK, &ctmp2,
                 &BLAS_C[(ns - 1) * NUM], &BM);
            }
        }
        ...
        */
        ...
        if (Eigen_MPI_flag == 1) {
            ...
            BroadCast_ComplexMatrix(MPI_CommWD2_DCLNO[myworld2_DCLNO], C, NUM, is2, ie2, myid2, numprocs2, stat_send,
                                    request_send, request_recv);
        }
                ...
                for (i = 0; i < tno1; i++) {
                    for (j = 0; j < tno2; j++) {
                        ...
                        for (i1 = 1; i1 < LO_TC[Mc_AN]; i1++) {
                            ...
                            /* Re11 */
                            tmp1 = HNC_ref(i1, 1 + i).r * HNC_ref(i1, Bnum + j).r +
                            ...
                            /* Re22 */
                            tmp1 = HNC_ref(i1, 1 + i + NUMH).r * HNC_ref(i1, Bnum + j + NUMH).r +
                            ...
                            /* Re12 */
                            tmp1 = HNC_ref(i1, 1 + i).r * HNC_ref(i1, Bnum + j + NUMH).r +
                            ...
                            /* Im12 */
                            tmp1 = -HNC_ref(i1, 1 + i).r * HNC_ref(i1, Bnum + j + NUMH).i +
                        ...
                        if (SO_switch == 1 || Hub_U_switch == 1 || 1 <= Constraint_NCS_switch ||
                            ...
                            for (i1 = 1; i1 < LO_TC[Mc_AN]; i1++) {
                                ...
                                /* Im11 */
                                tmp1 = -HNC_ref(i1, 1 + i).r * HNC_ref(i1, Bnum + j).i +
                                ...
                                /* Im22 */
                                tmp1 = -HNC_ref(i1, 1 + i + NUMH).r * HNC_ref(i1, Bnum + j + NUMH).i +
                        ...
                        for (i1 = LO_TC[Mc_AN]; i1 <= HO_TC[Mc_AN]; i1++) {
                            ...
                            /* Re22 */
                            Residues[1][Mc_AN - 1][h_AN][i][j][i2].r =
                                HNC_ref(i1, 1 + i + NUMH).r * HNC_ref(i1, Bnum + j + NUMH).r +
                                HNC_ref(i1, 1 + i + NUMH).i * HNC_ref(i1, Bnum + j + NUMH).i;

                            /* Re12 */
                            Residues[2][Mc_AN - 1][h_AN][i][j][i2].r =
                                HNC_ref(i1, 1 + i).r * HNC_ref(i1, Bnum + j + NUMH).r +
                                HNC_ref(i1, 1 + i).i * HNC_ref(i1, Bnum + j + NUMH).i;

                            /* Im12 */
                            Residues[2][Mc_AN - 1][h_AN][i][j][i2].i =
                                -HNC_ref(i1, 1 + i).r * HNC_ref(i1, Bnum + j + NUMH).i +
                                HNC_ref(i1, 1 + i).i * HNC_ref(i1, Bnum + j + NUMH).r;
                            ...
                            if (SO_switch == 1 || Hub_U_switch == 1 || 1 <= Constraint_NCS_switch ||
                                ...
                                /* Im11 */
                                Residues[0][Mc_AN - 1][h_AN][i][j][i2].i =
                                    -HNC_ref(i1, 1 + i).r * HNC_ref(i1, Bnum + j).i +
                                    HNC_ref(i1, 1 + i).i * HNC_ref(i1, Bnum + j).r;
                                ...
                                */
                                ...
                                /* Im22 */
                                Residues[1][Mc_AN - 1][h_AN][i][j][i2].i =
                                    -HNC_ref(i1, 1 + i + NUMH).r * HNC_ref(i1, Bnum + j + NUMH).i +
                                    HNC_ref(i1, 1 + i + NUMH).i * HNC_ref(i1, Bnum + j + NUMH).r;
                            }
                        }
                    }
            ...
            for (i = 0; i < tno1; i++) {
                for (h_AN = 0; h_AN <= FNAN[Gc_AN]; h_AN++) {
                    ...
                    for (j = 0; j < tno2; j++) {
                        ...
                        tmp1 = OLP0[Mc_AN][h_AN][i][j];
                        PDOS_DC[Mc_AN - 1][0] +=
                            (Residues[0][Mc_AN - 1][h_AN][i][j][0].r + Residues[1][Mc_AN - 1][h_AN][i][j][0].r) * tmp1;
                        PDOS_DC[Mc_AN - 1][1] +=
                            (Residues[0][Mc_AN - 1][h_AN][i][j][1].r + Residues[1][Mc_AN - 1][h_AN][i][j][1].r) * tmp1;

                        for (i1 = LO_TC[Mc_AN]; i1 <= HO_TC[Mc_AN]; i1++) {
                            i2 = i1 - LO_TC[Mc_AN] + 2;
                            PDOS_DC[Mc_AN - 1][i2] +=
                                (Residues[0][Mc_AN - 1][h_AN][i][j][i2].r + Residues[1][Mc_AN - 1][h_AN][i][j][i2].r) *
                                tmp1;
                        }
                    }
                }
    ...
    if (measure_time) {
        printf("Divide_Conquer_LNO myid0=%2d NUM=%2d time0=%7.3f time1=%7.3f time2=%7.3f time3=%7.3f time4=%7.3f "
               "time5=%7.3f time6=%7.3f time7=%7.3f time8=%7.3f\n",
               myid0, NUM, time0, time1, time2, time3, time4, time5, time6, time7, time8);
        fflush(stdout);
    }
                ...
                for (i = 0; i < tno1; i++) {
                    ...
                    for (h_AN = 0; h_AN <= FNAN[Gc_AN]; h_AN++) {
                        ...
                        for (j = 0; j < tno2; j++) {
                            ...
                            sum += Residues[spin][Mc_AN - 1][h_AN][i][j][i1 + 2] * OLP0[Mc_AN][h_AN][i][j];
                        }
                    }
            ...
            for (i = 0; i < tno1; i++) {
                ...
                for (h_AN = 0; h_AN <= FNAN[Gc_AN]; h_AN++) {
                    ...
                    for (j = 0; j < tno2; j++) {
                        ...
                        Re11 += Residues[0][Mc_AN - 1][h_AN][i][j][i2].r * OLP0[Mc_AN][h_AN][i][j];

                        Re22 += Residues[1][Mc_AN - 1][h_AN][i][j][i2].r * OLP0[Mc_AN][h_AN][i][j];

                        Re12 += Residues[2][Mc_AN - 1][h_AN][i][j][i2].r * OLP0[Mc_AN][h_AN][i][j];

                        Im12 += Residues[2][Mc_AN - 1][h_AN][i][j][i2].i * OLP0[Mc_AN][h_AN][i][j];
                    }
                }
