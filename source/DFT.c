...
static double Calc_optical_conductivities_dielectric_functions(
    int myid0, double ** ko_col, double Eele0[2], double Eele1[2], int * MP, int * order_GA, double * ko, double * koS,
    double *** EIGEN_Band, double * S1, double * H1, double * CDM1, dcomplex ** H_Band_Col, dcomplex ** S_Band,
    double * EDM1, int myworld1, int myworld2, int * NPROCS_ID1, int * Comm_World1, int * NPROCS_WD1,
    int * Comm_World_StartID1, MPI_Comm * MPI_CommWD1, int * NPROCS_ID2, int * NPROCS_WD2, int * Comm_World2,
    int * Comm_World_StartID2, MPI_Comm * MPI_CommWD2, int * is2, int * ie2, int size_H1, int * SP_NZeros,
    int * SP_Atoms, double ** EVec1_Re, double * Work1, double * Ss_Re, double * Cs_Re, double * Hs_Re,
    dcomplex * Ss_Cx, dcomplex * Cs_Cx, dcomplex * Hs_Cx);
...
double DFT(int MD_iter, int Cnt_Now)
{
    ...
    double     x, y, z;
    int        po3, po, scf_convergence_flag, TRAN_Poisson_flag2;
  ...
  ****************************************************/
	...
	*****************************************************/
                ...
                TRAN_Set_Electrode_Grid(mpi_comm_level1, &TRAN_Poisson_flag2, Grid_Origin, tv, Left_tv, Right_tv, gtv,
 	...
 	*****************************************************/
                ...
                TRAN_Add_Density_Lead(mpi_comm_level1, SpinP_switch, Ngrid1, Ngrid2, Ngrid3, My_NumGridB_AB,
                                      Density_Grid_B);

                TRAN_Add_ADensity_Lead(mpi_comm_level1, SpinP_switch, Ngrid1, Ngrid2, Ngrid3, My_NumGridB_AB,
                                       ADensity_Grid_B);
      ...
      ******************************************************/
        ...
        Thus, we call Set_Nonlocal again, since HNL depends on basis functions. */
                ...
                MPI_Allreduce(&My_SucceedReadingDMfile, &SucceedReadingDMfile, 1, MPI_INT, MPI_PROD, mpi_comm_level1);
	...
	*/
                ...
                if (Correct_Position_flag || Use_of_Collinear_Restart == 1 ||
                    (SO_switch == 0 && Hub_U_switch == 0 && Constraint_NCS_switch == 0 && Zeeman_NCS_switch == 0 &&
                     Zeeman_NCO_switch == 0) /* non-spin-orbit coupling and non-LDA+U */
                ) {

                    time3 += Set_Hamiltonian("nostdout", MD_iter, LSCF_iter - SCF_iter_shift, SCF_iter - SCF_iter_shift,
                                             TRAN_Poisson_flag2, SucceedReadingDMfile, Cnt_kind, H0, HNL, DM[0], H);
                }
            }
    ...
    ****************************************************/
            ...
            time3 += Set_Hamiltonian("stdout", MD_iter, LSCF_iter - SCF_iter_shift, SCF_iter - SCF_iter_shift,
                                     TRAN_Poisson_flag2, SucceedReadingDMfile, Cnt_kind, H0, HNL, DM[0], H);
    ...
    ****************************************************/
        ...
        if (Mixing_switch == 5 ||
            (Cnt_switch != 1 && SucceedReadingDMfile != 1 && (Mixing_switch == 1 || Mixing_switch == 6) &&
    ...
    ****************************************************/
        ...
        if (MYID_MPI_COMM_WORLD == Host_ID && 0 < level_stdout && scf_eigen_lib_flag == CuSOLVER && (Solver == 2 || Solver == 3 || Solver == 5 || Solver == 11)) {
        ...
        if (Cnt_switch == 0) {
            ...
            case 2:
                ...
                if (SpinP_switch <= 1) {
                    ...
                    time5 += Cluster_DFT_Col("scf", LSCF_iter, SpinP_switch, ko_col, H, OLP[0], DM[0], EDM, Eele0,
                                             Eele1, myworld1, NPROCS_ID1, Comm_World1, NPROCS_WD1, Comm_World_StartID1,
                                             MPI_CommWD1, MP, is2, ie2, Ss_Re, Cs_Re, Hs_Re, CDM1, EDM1, PDM1, size_H1,
                                             SP_NZeros, SP_Atoms, EVec1_Re, Work1);

                }

                else if (SpinP_switch == 3) {

                    time5 += Cluster_DFT_NonCol("scf", LSCF_iter, SpinP_switch, ko_noncol, H, iHNL, OLP[0], DM[0], EDM,
                                                Eele0, Eele1, MP, is2, ie2, Ss_Re, Cs_Re, rHs11_Re, rHs12_Re, rHs22_Re,
                                                iHs11_Re, iHs12_Re, iHs22_Re, Ss2_Cx, Hs2_Cx, Cs2_Cx, CDM1, size_H1,
                                                EVec1_NonCol, Work1);
                }
            ...
            case 3:
                ...
                if (SpinP_switch <= 1) {
                    ...
                    time5 += Band_DFT_Col(LSCF_iter, Kspace_grid1, Kspace_grid2, Kspace_grid3, SpinP_switch, H, iHNL,
                                          OLP[0], DM[0], EDM, Eele0, Eele1, MP, order_GA, ko, koS, EIGEN_Band, H1, S1,
                                          CDM1, EDM1, EVec1_Cx, Ss_Cx, Cs_Cx, Hs_Cx, k_op, T_k_op, T_k_ID, T_KGrids1,
                                          T_KGrids2, T_KGrids3, myworld1, NPROCS_ID1, Comm_World1, NPROCS_WD1,
                                          Comm_World_StartID1, MPI_CommWD1, myworld2, NPROCS_ID2, NPROCS_WD2,
                                          Comm_World2, Comm_World_StartID2, MPI_CommWD2);
                } else {

                    if (GB_switch == 0) {

                        time5 += Band_DFT_NonCol(LSCF_iter, Kspace_grid1, Kspace_grid2, Kspace_grid3, SpinP_switch, H,
                                                 iHNL, OLP[0], DM[0], EDM, Eele0, Eele1, MP, order_GA, ko_noncol, koS,
                                                 EIGEN_Band, H1, S1, rHs11_Cx, rHs22_Cx, rHs12_Cx, iHs11_Cx, iHs22_Cx,
                                                 iHs12_Cx, EVec1_Cx, Ss_Cx, Cs_Cx, Hs_Cx, Ss2_Cx, Cs2_Cx, Hs2_Cx, k_op,
                                                 T_k_op, T_k_ID, T_KGrids1, T_KGrids2, T_KGrids3, myworld1, NPROCS_ID1,
                                                 Comm_World1, NPROCS_WD1, Comm_World_StartID1, MPI_CommWD1, myworld2,
                                                 NPROCS_ID2, NPROCS_WD2, Comm_World2, Comm_World_StartID2, MPI_CommWD2);
                    } else if (GB_switch == 1) {
                        /* added by T. B. Prayitno and supervised by Prof. F. Ishii*/
                        time5 +=
                            Band_DFT_NonCol_GB(LSCF_iter, koSU, koSL, SU_Band, SL_Band, Kspace_grid1, Kspace_grid2,
                                               Kspace_grid3, SpinP_switch, H, iHNL, OLP[0], DM[0], EDM, Eele0, Eele1);
                    }
                }
            ...
            case 4:
                ...
                if (SpinP_switch < 2) {
                    time5 +=
                        TRAN_DFT(mpi_comm_level1, SucceedReadingDMfile, level_stdout, LSCF_iter, SpinP_switch, H, iHNL,
                                 OLP[0], atomnum, Matomnum, WhatSpecies, Spe_Total_CNO, FNAN, natn, ncn, M2G, G2ID,
                                 F_G2M, atv_ijk, List_YOUSO, DM[0], EDM, TRAN_DecMulP, Eele0, Eele1, ChemP_e0);
                } else {
                    time5 += TRAN_DFT_NC(mpi_comm_level1, SucceedReadingDMfile, level_stdout, LSCF_iter, SpinP_switch,
                                         H, iHNL, OLP[0], atomnum, Matomnum, WhatSpecies, Spe_Total_CNO, FNAN, natn,
                                         ncn, M2G, G2ID, F_G2M, atv_ijk, List_YOUSO, koS, S_Band, DM[0], iDM[0], EDM,
                                         TRAN_DecMulP, Eele0, Eele1, ChemP_e0);
                } /* until here by Y. Xiao for Noncollinear NEGF calculations*/
            ...
            case 9:
                time5 += Cluster_DFT_ON2("scf", LSCF_iter, SpinP_switch, H, iHNL, OLP[0], DM[0], EDM, Eele0, Eele1);
                break;
            ...
            case 11:
                time5 += Divide_Conquer_LNO("scf", MD_iter, LSCF_iter, SucceedReadingDMfile, H, iHNL, OLP[0], DM[0],
                                            EDM, Eele0, Eele1);
                break;

            case 12:
                time5 += Cluster_DFT_LNO("scf", LSCF_iter, SpinP_switch, Cluster_ReCoes, ko_col, H, iHNL, OLP[0], DM[0],
                                         EDM, NULL, NULL, NULL, Eele0, Eele1);
                break;
            }
        }
            ...
            case 2:
                ...
                if (SpinP_switch <= 1) {
                    ...
                    time5 += Cluster_DFT_Col("scf", LSCF_iter, SpinP_switch, ko_col, CntH, CntOLP[0], DM[0], EDM, Eele0,
                                             Eele1, myworld1, NPROCS_ID1, Comm_World1, NPROCS_WD1, Comm_World_StartID1,
                                             MPI_CommWD1, MP, is2, ie2, Ss_Re, Cs_Re, Hs_Re, CDM1, EDM1, PDM1, size_H1,
                                             SP_NZeros, SP_Atoms, EVec1_Re, Work1);
                }
            ...
            case 3:
                ...
                if (SpinP_switch <= 1) {
                    ...
                    time5 += Band_DFT_Col(LSCF_iter, Kspace_grid1, Kspace_grid2, Kspace_grid3, SpinP_switch, CntH,
                                          iCntHNL, CntOLP[0], DM[0], EDM, Eele0, Eele1, MP, order_GA, ko, koS,
                                          EIGEN_Band, H1, S1, CDM1, EDM1, EVec1_Cx, Ss_Cx, Cs_Cx, Hs_Cx, k_op, T_k_op,
                                          T_k_ID, T_KGrids1, T_KGrids2, T_KGrids3, myworld1, NPROCS_ID1, Comm_World1,
                                          NPROCS_WD1, Comm_World_StartID1, MPI_CommWD1, myworld2, NPROCS_ID2,
                                          NPROCS_WD2, Comm_World2, Comm_World_StartID2, MPI_CommWD2);
                    ...
                    if (GB_switch == 0) {
                        ...
                        time5 += Band_DFT_NonCol(
                            LSCF_iter, Kspace_grid1, Kspace_grid2, Kspace_grid3, SpinP_switch, CntH, iCntHNL, CntOLP[0],
                            DM[0], EDM, Eele0, Eele1, MP, order_GA, ko_noncol, koS, EIGEN_Band, H1, S1, rHs11_Cx,
                            rHs22_Cx, rHs12_Cx, iHs11_Cx, iHs22_Cx, iHs12_Cx, EVec1_Cx, Ss_Cx, Cs_Cx, Hs_Cx, Ss2_Cx,
                            Cs2_Cx, Hs2_Cx, k_op, T_k_op, T_k_ID, T_KGrids1, T_KGrids2, T_KGrids3, myworld1, NPROCS_ID1,
                            Comm_World1, NPROCS_WD1, Comm_World_StartID1, MPI_CommWD1, myworld2, NPROCS_ID2, NPROCS_WD2,
                            Comm_World2, Comm_World_StartID2, MPI_CommWD2);
                    } else if (GB_switch == 1) {
                        /* added by T. B. Prayitno and supervised by Prof. F. Ishii*/
                        time5 += Band_DFT_NonCol_GB(LSCF_iter, koSU, koSL, SU_Band, SL_Band, Kspace_grid1, Kspace_grid2,
                                                    Kspace_grid3, SpinP_switch, CntH, iCntHNL, CntOLP[0], DM[0], EDM,
                                                    Eele0, Eele1);
                    }
                }
            ...
            case 9:
                time5 +=
                    Cluster_DFT_ON2("scf", LSCF_iter, SpinP_switch, CntH, iCntHNL, CntOLP[0], DM[0], EDM, Eele0, Eele1);
                break;
            ...
            case 11:
                time5 += Divide_Conquer_LNO("scf", MD_iter, LSCF_iter, SucceedReadingDMfile, CntH, iCntHNL, CntOLP[0],
    ...
    *****************************************************/
        ...
        if (2 <= SCF_iter && ((dUele < SCF_Criterion && NormRD[0] < (10 * SCF_Criterion) && Cnt_switch == 0) ||
    ...
    *****************************************************/
        ...
        if (Cnt_switch == 1 && Cnt_Now == 1 && OrbOpt_end != 1 &&
            (LSCF_iter % orbitalOpt_SCF == 0 || (dUele < SCF_Criterion && NormRD[0] < 1.0e-7))) {
	...
	time8 += Total_Energy(MD_iter,ECE);
	...
	printf("orbitalOpt_iter=%3d Etot=%15.12f\n",orbitalOpt_iter,TotalE);
      */
            ...
            if (Opt_Contraction(orbitalOpt_iter, 0.0, /* <- TotalE  */
                                H, OLP, DM[0], EDM, His_CntCoes, His_D_CntCoes, His_CntCoes_Species,
                                His_D_CntCoes_Species, His_OrbOpt_Etot, OrbOpt_Hessian) < orbitalOpt_criterion) {
    ...
    ********************************************************/
        ...
        if (SCF_iter == TRAN_SCF_Iter_Band)
            SCF_iter_shift = TRAN_SCF_Iter_Band;
    ...
    ********************************************************/
        ...
        if (Mixing_switch == 0 || Mixing_switch == 1 || Mixing_switch == 2 || Mixing_switch == 6) {
            ...
            time6 += Mixing_DM(MD_iter, LSCF_iter - SCF_iter_shift, SCF_iter - SCF_iter_shift, SucceedReadingDMfile,
                               ReRhok, ImRhok, Residual_ReRhok, Residual_ImRhok, ReVk, ImVk, ReRhoAtomk, ImRhoAtomk);
            ...
            if (SpinP_switch == 3) {
                ...
                if (0 < level_stdout) {
                    printf("<DFT>  Total Spin Moment    (muB) %12.9f   Angles %14.9f  %14.9f\n", 2.0 * Total_SpinS,
                           Total_SpinAngle0 / PI * 180.0, Total_SpinAngle1 / PI * 180.0);
                    fflush(stdout);
                    printf("<DFT>  Total Orbital Moment (muB) %12.9f   Angles %14.9f  %14.9f\n", Total_OrbitalMoment,
                           Total_OrbitalMomentAngle0 / PI * 180.0, Total_OrbitalMomentAngle1 / PI * 180.0);
                    fflush(stdout);
                }
                ...
                if (0 < level_stdout) {
                    printf("<DFT>  Total Moment         (muB) %12.9f   Angles %14.9f  %14.9f\n", S_coordinate[0],
                           S_coordinate[1] / PI * 180.0, S_coordinate[2] / PI * 180.0);
                    fflush(stdout);
                }
    ...
    *****************************************************/
        ...
        if (1 < MD_iter && SucceedReadingDMfile == 1 && Scf_RestartFromFile != -1 && Pulay_SCF == Pulay_SCF_original &&
            SCF_iter < Pulay_SCF_original && NormRD[0] < 0.01 && Pulay_SCF_original < SCF_MAX) {
    ...
    ************************************************************************/
    ...
    if (po == 0)
        scf_convergence_flag = 0;
    else
        scf_convergence_flag = 1;
  ...
  *******************************************************************/
    ...
    if (CDDF_on == 1) {
        ...
        time5 += Calc_optical_conductivities_dielectric_functions(
            myid0, ko_col, Eele0, Eele1, MP, order_GA, ko, koS, EIGEN_Band, S1, H1, CDM1, H_Band_Col, S_Band, EDM1,
            myworld1, myworld2, NPROCS_ID1, Comm_World1, NPROCS_WD1, Comm_World_StartID1, MPI_CommWD1, NPROCS_ID2,
            NPROCS_WD2, Comm_World2, Comm_World_StartID2, MPI_CommWD2, is2, ie2, size_H1, SP_NZeros, SP_Atoms, EVec1_Re,
            Work1, Ss_Re, Cs_Re, Hs_Re, Ss_Cx, Cs_Cx, Hs_Cx);
    }
  ...
  *******************************************************************/
    ...
    TRAN_Output_Trans_HS(mpi_comm_level1, Solver, SpinP_switch, ChemP, H, iHNL, OLP, H0, atomnum, SpeciesNum,
                         WhatSpecies, Spe_Total_CNO, FNAN, natn, ncn, G2ID, atv_ijk, Max_FSNAN, ScaleSize, F_G2M,
                         TCpyCell, List_YOUSO, filepath, filename, "tranb");
  ...
  *****************************************************/
    ...
    if (Band_disp_switch == 1 && Band_Nkpath > 0 && LNO_flag == 1) {
        ...
        Band_DFT_kpath_LNO(Band_Nkpath, Band_N_perpath, Band_kpath, Band_kname, SpinP_switch, H, iHNL, OLP[0]);
    }
    ...
    /* For the conventional method */
        ...
        if (Cnt_switch == 0) {
            ...
            Band_DFT_kpath(Band_Nkpath, Band_N_perpath, Band_kpath, Band_kname, SpinP_switch, H, iHNL, OLP[0]);
        } else {

            Band_DFT_kpath(Band_Nkpath, Band_N_perpath, Band_kpath, Band_kname, SpinP_switch, CntH, iCntHNL, CntOLP[0]);
        }
    }
  ...
  ******************************************************/
    ...
    if (Dos_fileout || DosGauss_fileout) {
        ...
        if (Solver == 2) { /* cluster */
            ...
            if (Cnt_switch == 0) {
                ...
                if (SpinP_switch <= 1) {
                    ...
                    time5 += Cluster_DFT_Col("dos", LSCF_iter, SpinP_switch, ko_col, H, OLP[0], DM[0], EDM, Eele0,
                                             Eele1, myworld1, NPROCS_ID1, Comm_World1, NPROCS_WD1, Comm_World_StartID1,
                                             MPI_CommWD1, MP, is2, ie2, Ss_Re, Cs_Re, Hs_Re, CDM1, EDM1, PDM1, size_H1,
                                             SP_NZeros, SP_Atoms, EVec1_Re, Work1);
                } else if (SpinP_switch == 3) {

                    time5 += Cluster_DFT_NonCol("dos", LSCF_iter, SpinP_switch, ko_noncol, H, iHNL, OLP[0], DM[0], EDM,
                                                Eele0, Eele1, MP, is2, ie2, Ss_Re, Cs_Re, rHs11_Re, rHs12_Re, rHs22_Re,
                                                iHs11_Re, iHs12_Re, iHs22_Re, Ss2_Cx, Hs2_Cx, Cs2_Cx, CDM1, size_H1,
                                                EVec1_NonCol, Work1);
                }
                ...
                if (SpinP_switch <= 1) {
                    ...
                    time5 += Cluster_DFT_Col("dos", LSCF_iter, SpinP_switch, ko_col, CntH, CntOLP[0], DM[0], EDM, Eele0,
                                             Eele1, myworld1, NPROCS_ID1, Comm_World1, NPROCS_WD1, Comm_World_StartID1,
                                             MPI_CommWD1, MP, is2, ie2, Ss_Re, Cs_Re, Hs_Re, CDM1, EDM1, PDM1, size_H1,
                                             SP_NZeros, SP_Atoms, EVec1_Re, Work1);
                } else if (SpinP_switch == 3) {
            ...
            if (Cnt_switch == 0) {
                ...
                Band_DFT_Dosout(Dos_Kgrid[0], Dos_Kgrid[1], Dos_Kgrid[2], SpinP_switch, H, iHNL, OLP[0]);
            } else {
                Band_DFT_Dosout(Dos_Kgrid[0], Dos_Kgrid[1], Dos_Kgrid[2], SpinP_switch, CntH, iCntHNL, CntOLP[0]);
            }
        }

        else if (Solver == 4) { /* NEGF */

            TRAN_DFT_Dosout(mpi_comm_level1, level_stdout, LSCF_iter, SpinP_switch, H, iHNL, OLP[0], atomnum, Matomnum,
                            WhatSpecies, Spe_Total_CNO, FNAN, natn, ncn, M2G, G2ID, atv_ijk, List_YOUSO, Spe_Num_CBasis,
                            SpeciesNum, filename, filepath, SucceedReadingDMfile, DM[0], EDM, Eele0, Eele1);

        }

        else if (Solver == 5) { /* divide-conquer */
            if (Cnt_switch == 0) {
        ...
        else if (Solver == 8) { /* Krylov subspace method */
            if (Cnt_switch == 0) {
        ...
        else if (Solver == 11) { /* DC-LNO */
            if (Cnt_switch == 0) {
                time5 += Divide_Conquer_LNO("dos", MD_iter, LSCF_iter, SucceedReadingDMfile, H, iHNL, OLP[0], DM[0],
                                            EDM, Eele0, Eele1);
            } else {
                time5 += Divide_Conquer_LNO("dos", MD_iter, LSCF_iter, SucceedReadingDMfile, CntH, iCntHNL, CntOLP[0],
                                            DM[0], EDM, Eele0, Eele1);
            }
        }
    }
  ...
  ****************************************************/
    ...
    if (Solver == 4) {
        TRAN_Add_Density_Lead(mpi_comm_level1, SpinP_switch, Ngrid1, Ngrid2, Ngrid3, My_NumGridB_AB, Density_Grid_B);
    }
    ...
    if (Mixing_switch == 3 || Mixing_switch == 4) {
        ...
        time6 += Mixing_DM(1, LSCF_iter - SCF_iter_shift, SCF_iter - SCF_iter_shift, SucceedReadingDMfile, ReRhok,
                           ImRhok, Residual_ReRhok, Residual_ImRhok, ReVk, ImVk, ReRhoAtomk, ImRhoAtomk);
    }
  ...
  ****************************************************/
    ...
    if (Solver == 9) {
        ...
        if (Cnt_switch == 0) {
            time5 += Cluster_DFT_ON2("force", LSCF_iter, SpinP_switch, H, iHNL, OLP[0], DM[0], EDM, Eele0, Eele1);
        } else {

            time5 +=
                Cluster_DFT_ON2("force", LSCF_iter, SpinP_switch, CntH, iCntHNL, CntOLP[0], DM[0], EDM, Eele0, Eele1);
        }
    }
...
Last1:
  ...
  *********************************************************/
    ...
    if ((xanes_gs_fileout == 1 || xanes_calc == 1) && SpinP_switch <= 1) {

        char command[YOUSO10];

        if (xanes_gs_fileout == 1)
            sprintf(command, "lcaoout");
        else if (xanes_calc == 1)
            sprintf(command, "xanes");

        /* allocation of arrays */

        Allocate_Free_Cluster_Col(1);

        /* call Cluster_DFT_Col */

        time5 += Cluster_DFT_Col(command, 1, SpinP_switch, ko_col, H, OLP[0], DM[0], EDM, Eele0, Eele1, myworld1,
                                 NPROCS_ID1, Comm_World1, NPROCS_WD1, Comm_World_StartID1, MPI_CommWD1, MP, is2, ie2,
                                 Ss_Re, Cs_Re, Hs_Re, CDM1, EDM1, PDM1, size_H1, SP_NZeros, SP_Atoms, EVec1_Re, Work1);
    ...
    else if ((xanes_gs_fileout == 1 || xanes_calc == 1) && SpinP_switch == 3) {
        ...
        /* call Cluster_DFT_NonCol */

        time5 += Cluster_DFT_NonCol(command, 1, SpinP_switch, ko_noncol, H, iHNL, OLP[0], DM[0], EDM, Eele0, Eele1, MP,
                                    is2, ie2, Ss_Re, Cs_Re, rHs11_Re, rHs12_Re, rHs22_Re, iHs11_Re, iHs12_Re, iHs22_Re,
                                    Ss2_Cx, Hs2_Cx, Cs2_Cx, CDM1, size_H1, EVec1_NonCol, Work1);
    ...
    /*********************************************************
          check if the calculation finished normally. 
  *********************************************************/
    ...
    sprintf(nanchar, "%8.4f", NormRD[0]);

    if (strstr(nanchar, "nan") != NULL || strstr(nanchar, "NaN") != NULL || strstr(nanchar, "inf") != NULL ||
        strstr(nanchar, "Inf") != NULL) {

        if (myid0 == Host_ID) {
            printf("The calculation was terminated due to the illegal SCF calculation.\n");
        }
    ...
    /* show a message about the SCF convergence */

    if (scf_convergence_flag == 1) {
        if (myid0 == Host_ID)
            printf("\nThe SCF was achieved at MD=%4d\n", MD_iter);
    } else {
        if (myid0 == Host_ID)
            printf("\nThe SCF was not fully achieved at MD=%4d\n", MD_iter);
    }
...
void Output_Energies_Forces(FILE * fp)
{
    ...
    for (ct_AN = 1; ct_AN <= atomnum; ct_AN++) {
        fprintf(fp, "   %i %i        %12.9f  %12.9f  %12.9f\n", ct_AN, WhatSpecies[ct_AN], -Gxyz[ct_AN][17],
                -Gxyz[ct_AN][18], -Gxyz[ct_AN][19]);
    ...
    dcomplex * Ss_Cx, dcomplex * Cs_Cx, dcomplex * Hs_Cx)
{
    ...
    if (SpinP_switch == 3)
        CDDF_approach = 1; /* for non-collinear case */
    if (CDDF_approach == 1)
        Calc_OLP_r(1, myid0); /* calculate OLPpox = <a|r|b> */
    /* YTL-New-end */
    ...
    case 2:
        ...
        time5 = Cluster_DFT_Optical_ScaLAPACK("scf", 1, SpinP_switch, ko_col, H, iHNL, OLP[0], DM[0], EDM, NULL, NULL,
                                              NULL, Eele0, Eele1, myworld1, NPROCS_ID1, Comm_World1, NPROCS_WD1,
                                              Comm_World_StartID1, MPI_CommWD1, is2, ie2, Ss_Re, Cs_Re, Hs_Re, CDM1,
                                              size_H1, SP_NZeros, SP_Atoms, EVec1_Re, Work1);
        break;
    ...
    case 3:
        ...
        if (SpinP_switch <= 1) {
            ...
            time5 = Band_DFT_Col_Optical_ScaLAPACK(1, CDDF_Kspace_grid1, CDDF_Kspace_grid2, CDDF_Kspace_grid3,
                                                   SpinP_switch, H, iHNL, OLP[0], DM[0], EDM, Eele0, Eele1, MP,
                                                   order_GA, ko, koS, H1, S1, CDM1, EDM1, H_Band_Col);

        } else {

            time5 = Band_DFT_NonCol_Optical(1, koS, S_Band, CDDF_Kspace_grid1, CDDF_Kspace_grid2, CDDF_Kspace_grid3,
...
void Allocate_Free_Band_Col(int todo_flag)
{
  ...
  ********************************************/
    ...
    ***********************************************/
        ...
        Make_Comm_Worlds(mpi_comm_level1, myid0, numprocs0, Num_Comm_World1, &myworld1, MPI_CommWD1, NPROCS_ID1,
                         Comm_World1, NPROCS_WD1, Comm_World_StartID1);
    ...
    ***********************************************/
        ...
        Make_Comm_Worlds(MPI_CommWD1[myworld1], myid1, numprocs1, Num_Comm_World2, &myworld2, MPI_CommWD2, NPROCS_ID2,
                         Comm_World2, NPROCS_WD2, Comm_World_StartID2);
    ...
    *************************************************** */
        ...
        if (firsttime && memoryusage_fileout) {
            ...
            PrintMemory("Allocate_Free_Band_Col: ko_op", sizeof(double) * Kspace_grid1 * Kspace_grid2 * Kspace_grid3,
                        NULL);
  ...
  ********************************************/
    ...
    *************************************************** */
        ...
        if (scf_eigen_lib_flag == CuSOLVER && myid2 == 0) {
            ...
            rHs22_Cx = (dcomplex *)malloc(sizeof(dcomplex) * n * n);
            iHs11_Cx = (dcomplex *)malloc(sizeof(dcomplex) * n * n);
            iHs12_Cx = (dcomplex *)malloc(sizeof(dcomplex) * n * n);
            iHs22_Cx = (dcomplex *)malloc(sizeof(dcomplex) * n * n);
        } else if (scf_eigen_lib_flag == CuSOLVER) {
            Cs_Cx    = (dcomplex *)malloc(sizeof(dcomplex) * 1);
            rHs11_Cx = (dcomplex *)malloc(sizeof(dcomplex) * 1);
            rHs12_Cx = (dcomplex *)malloc(sizeof(dcomplex) * 1);
            rHs22_Cx = (dcomplex *)malloc(sizeof(dcomplex) * 1);
            iHs11_Cx = (dcomplex *)malloc(sizeof(dcomplex) * 1);
            iHs12_Cx = (dcomplex *)malloc(sizeof(dcomplex) * 1);
            iHs22_Cx = (dcomplex *)malloc(sizeof(dcomplex) * 1);
        } else {
            Cs_Cx    = (dcomplex *)malloc(sizeof(dcomplex) * na_rows_max * na_cols_max);
    ...
    *************************************************** */
        ...
        if (firsttime && memoryusage_fileout) {
            ...
            PrintMemory("Allocate_Free_Band_NonCol: ko_op", sizeof(double) * Kspace_grid1 * Kspace_grid2 * Kspace_grid3,
                        NULL);
    ...
    if (todo_flag == 1) {
       ...
       *************************************************** */
        ...
        if (scf_eigen_lib_flag == CuSOLVER && myid0 == 0) {
            Ss_Re    = (double *)malloc(sizeof(double) * n * n);
            rHs11_Re = (double *)malloc(sizeof(double) * n * n);
            rHs12_Re = (double *)malloc(sizeof(double) * n * n);
            rHs22_Re = (double *)malloc(sizeof(double) * n * n);
            iHs11_Re = (double *)malloc(sizeof(double) * n * n);
            iHs12_Re = (double *)malloc(sizeof(double) * n * n);
            iHs22_Re = (double *)malloc(sizeof(double) * n * n);
        } else if (scf_eigen_lib_flag == CuSOLVER) {
            Ss_Re    = (double *)malloc(sizeof(double) * 1);
            rHs11_Re = (double *)malloc(sizeof(double) * 1);
            rHs12_Re = (double *)malloc(sizeof(double) * 1);
            rHs22_Re = (double *)malloc(sizeof(double) * 1);
            iHs11_Re = (double *)malloc(sizeof(double) * 1);
            iHs12_Re = (double *)malloc(sizeof(double) * 1);
            iHs22_Re = (double *)malloc(sizeof(double) * 1);
        } else {
            Ss_Re    = (double *)malloc(sizeof(double) * na_rows * na_cols);
  ...
  ********************************************/
    ...
    if (todo_flag == 1) {
        ...
        if (firsttime && memoryusage_fileout) {
            ...
            PrintMemory("Allocate_Free_GridData: ReRhok", sizeof(double) * List_YOUSO[38] * spinmax * My_Max_NumGridB,
                        NULL);
            PrintMemory("Allocate_Free_GridData: ImRhok", sizeof(double) * List_YOUSO[38] * spinmax * My_Max_NumGridB,
                        NULL);
            PrintMemory("Allocate_Free_GridData: Residual_ReRhok",
                        sizeof(double) * List_YOUSO[38] * spinmax * My_NumGridB_CB, NULL);
            PrintMemory("Allocate_Free_GridData: Residual_ImRhok",
                        sizeof(double) * List_YOUSO[38] * spinmax * My_NumGridB_CB, NULL);
        }
        firsttime = 0;
...
void Allocate_Free_OrbOpt(int todo_flag)
{
  ...
  ********************************************/
    ...
    if (todo_flag == 1) {
        ...
        if (firsttime && memoryusage_fileout) {
            PrintMemory("Allocate_Free_OrbOpt: His_CntCoes",
                        sizeof(double) * (orbitalOpt_History + 1) * (Matomnum + 1) * List_YOUSO[7] * List_YOUSO[24],
                        NULL);
            PrintMemory("Allocate_Free_OrbOpt: His_D_CntCoes",
                        sizeof(double) * (orbitalOpt_History + 1) * (Matomnum + 1) * List_YOUSO[7] * List_YOUSO[24],
                        NULL);
            PrintMemory("Allocate_Free_OrbOpt: His_CntCoes_Species",
                        sizeof(double) * (orbitalOpt_History + 1) * (Matomnum + 1) * List_YOUSO[7] * List_YOUSO[24],
                        NULL);
            PrintMemory("Allocate_Free_OrbOpt: His_D_CntCoes_Species",
                        sizeof(double) * (orbitalOpt_History + 1) * (Matomnum + 1) * List_YOUSO[7] * List_YOUSO[24],
                        NULL);
