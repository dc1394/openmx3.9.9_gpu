#ifndef _OPENMX_COMMON_H_
#define _OPENMX_COMMON_H_
...
//     cusolverMpGrid_t gridA;
//     cusolverMpGrid_t gridQ;
...
int StressConsistency_flag, stress_flag, scf_stress_flag, MD_cellopt_flag, cellopt_switch;
...
int    memoryusage_fileout, monitoring_memory_usage;
...
double AngularF(int l, int m, double Q, double P, int Use_switch, double siQ, double coQ, double siP, double coP);
...
double Nonlocal_Basis(int wan, int Lnum_index, int Mnum, int so, double r, double theta, double phi);
...
void EulerAngle_Spin(int quickcalc_flag, double Re11, double Re22, double Re12, double Im12, double Re21, double Im21,
...
double Mixing_DM(int MD_iter, int SCF_iter, int SCF_iter0, int SucceedReadingDMfile, double *** ReRhok,
                 double *** ImRhok, double ** Residual_ReRhok, double ** Residual_ImRhok, double * ReVk, double * ImVk,
                 double * ReRhoAtomk, double * ImRhoAtomk);

double Mixing_H(int MD_iter, int SCF_iter, int SCF_iter0);

double Mixing_V(int MD_iter, int SCF_iter, int SCF_iter0);

void Simple_Mixing_DM(int Change_switch, double Mix_wgt, double ***** CDM, double ***** PDM, double ***** P2DM,
                      double ***** iCDM, double ***** iPDM, double ***** iP2DM, double ***** RDM, double ***** iRDM);
...
void Kerker_Mixing_Rhok(int Change_switch, double Mix_wgt, double *** ReRhok, double *** ImRhok,
                        double ** Residual_ReRhok, double ** Residual_ImRhok, double * ReVk, double * ImVk,
                        double * ReRhoAtomk, double * ImRhoAtomk);

void DIIS_Mixing_Rhok(int SCF_iter, double Mix_wgt, double *** ReRhok, double *** ImRhok, double ** Residual_ReRhok,
                      double ** Residual_ImRhok, double * ReVk, double * ImVk, double * ReRhoAtomk,
                      double * ImRhoAtomk);
...
void Hamiltonian_Cluster_NC(double ***** RH, double ***** IH, dcomplex ** H, int * MP);
void Hamiltonian_Cluster_SO(double **** RH, double **** IH, dcomplex ** H, int * MP);
void Hamiltonian_Band(int Host_ID1, double **** RH, dcomplex ** H, int * MP, double k1, double k2, double k3);
void Hamiltonian_Band_NC(int Host_ID1, double ***** RH, double ***** IH, dcomplex ** H, int * MP, double k1, double k2,
                         double k3);
int  Get_OneD_HS_Col(int set_flag, double **** RH, double * H1, int * MP, int * order_GA, int * My_NZeros, int * is1,
                     int * is2);
void Overlap_Band(int Host_ID1, double **** OLP, dcomplex ** S, int * MP, double k1, double k2, double k3);

void Matrix_Band_LNO(int Host_ID1, int spin, double **** OLP, dcomplex ** S, int * MP, double k1, double k2, double k3);

void   Initial_CntCoes(double ***** nh, double ***** OLP);
void   Initial_CntCoes2(double ***** nh, double ***** OLP);
double Opt_Contraction(int orbitalOpt_iter, double TotalE, double ***** H, double ***** OLP, double ***** CDM,
                       double ***** EDM, double **** His_CntCoes, double **** His_D_CntCoes,
                       double **** His_CntCoes_Species, double **** His_D_CntCoes_Species, double * His_OrbOpt_Etot,
                       double ** OrbOpt_Hessian);

void Contract_Hamiltonian(double ***** H, double ***** CntH, double ***** OLP, double ***** CntOLP);
...
double EC(char * mode, int SCF_iter, double ***** Hks, double ***** ImNL, double **** OLP0, double ***** CDM,
          double ***** EDM, double Eele0[2], double Eele1[2]);
...
double Divide_Conquer_LNO(char * mode, int MD_iter, int SCF_iter, int SucceedReadingDMfile, double ***** Hks,
                          double ***** ImNL, double **** OLP0, double ***** CDM, double ***** EDM, double Eele0[2],
                          double Eele1[2]);
...
// void cublasmp_zgemm(cublasOperation_t transA, cublasOperation_t transB, cuDoubleComplex* d_A, cuDoubleComplex* d_B, cuDoubleComplex* d_C, Options* opts, Options2* opts2);

// void destroy_cublasmp(Options2* opts2);

// void init_cusolvermp(int myworld2, MPI_Comm* MPI_CommWD2, Options2* opts2, Options3* opts3, Options4* opts4);

// int cusolvermp_syevd(cuDoubleComplex* d_A, cuDoubleComplex* d_Q, double* d_D, Options2* opts2, Options3* opts3, Options4* opts4);

// void destroy_cusolvermp(Options4* opts4);

double Krylov(char * mode, int SCF_iter, double ***** Hks, double ***** ImNL, double **** OLP0, double ***** CDM,
              double ***** EDM, double Eele0[2], double Eele1[2]);
double Divide_Conquer_Dosout(double ***** Hks, double ***** ImNL, double **** OLP0);
double EGAC_DFT(char * mode, int SCF_iter, int SpinP_switch, double ***** Hks, double ***** ImNL, double **** OLP0,
                double ***** CDM, double ***** EDM, double Eele0[2], double Eele1[2]);
...
void xyz2spherical(double x, double y, double z, double xo, double yo, double zo, double S_coordinate[3]);
...
double Poisson(int fft_charge_flag, double * ReDenk, double * ImDenk);

double FFT_Density(int den_flag, double * ReDenk, double * ImDenk);

void Get_Value_inReal(int complex_flag, double * ReVr, double * ImVr, double * ReVk, double * ImVk);

void Inverse_FFT_Poisson(double * ReRhor, double * ImRhor, double * ReRhok, double * ImRhok);

void FFT_Poisson(double * ReRhor, double * ImRhor, double * ReRhok, double * ImRhok);

/** Effective Screening Medium (ESM) Method Calculation (added by T.Ohwaki) **/

double Poisson_ESM(int fft_charge_flag, double * ReRhok, double * ImRhok);
...
double Stress(double ***** H0, double ****** DS_NL, double ***** OLP, double ***** CDM, double ***** EDM);
...
void   Set_Vpot(int MD_iter, int SCF_iter, int SCF_iter0, int TRAN_Poisson_flag2, int XC_P_switch);
void   Set_XC_Grid(int SCF_iter, int XC_P_switch, int XC_switch, double * Den0, double * Den1, double * Den2,
                   double * Den3, double * Vxc0, double * Vxc1, double * Vxc2, double * Vxc3, double *** dEXC_dGD,
                   double *** dDen_Grid);

void Set_XC_NL1_Grid(int SCF_iter, int XC_P_switch, int XC_switch, double * Den0, double * Den1, double * Den2,
                     double * Den3, double * Vxc0, double * Vxc1, double * Vxc2, double * Vxc3, double *** dEXC_dGD,
                     double *** dDen_Grid);
...
void   XC_PBE(int SCF_iter, double dens[2], double GDENS[3][2], double Exc[2], double DEXDD[2], double DECDD[2],
...
void Calc_NAO_Band(int nkpoint, double ** kpoint, int SpinP_switch, double ***** nh, double **** OLP);
...
double Cluster_DFT_LNO(char * mode, int SCF_iter, int SpinP_switch, double *** Cluster_ReCoes, double ** Cluster_ko,
                       double ***** nh, double ***** ImNL, double **** OLP0, double ***** CDM, double ***** EDM,
                       EXX_t * exx, dcomplex **** exx_CDM, double * Uexx, double Eele0[2], double Eele1[2]);

double Cluster_DFT_Dosout(int SpinP_switch, double ***** nh, double ***** ImNL, double **** CntOLP);

double Cluster_DFT_ON2(char * mode, int SCF_iter, int SpinP_switch, double ***** nh, double ***** ImNL,
                       double **** CntOLP, double ***** CDM, double ***** EDM, double Eele0[2], double Eele1[2]);
...
*/
double Band_DFT_NonCol_GB(int SCF_iter, double * koSU, double * koSL, dcomplex ** SU, dcomplex ** SL, int knum_i,
                          int knum_j, int knum_k, int SpinP_switch, double ***** nh, double ***** ImNL,
                          double **** CntOLP, double ***** CDM, double ***** EDM, double Eele0[2], double Eele1[2]);

void k_inversion(int i, int j, int k, int mi, int mj, int mk, int * ii, int * ij, int * ik);
void Band_DFT_kpath(int nkpath, int * n_perk, double *** kpath, char *** kname, int SpinP_switch, double ***** nh,
                    double ***** ImNL, double **** CntOLP);

void Band_DFT_kpath_LNO(int nkpath, int * n_perk, double *** kpath, char *** kname, int SpinP_switch, double ***** nh,
                        double ***** ImNL, double **** CntOLP);

void   Band_DFT_MO(int nkpoint, double ** kpoint, int SpinP_switch, double ***** nh, double ***** ImNL,
                   double **** CntOLP);
double Band_DFT_Dosout(int knum_i, int knum_j, int knum_k, int SpinP_switch, double ***** nh, double ***** ImNL,
                       double **** CntOLP);

void Unfolding_Bands(int nkpoint, double ** kpoint, int SpinP_switch, double ***** nh, double ***** ImNL,
                     double **** CntOLP);
...
void   outputfile1(int f_switch, int MD_iter, int orbitalOpt_iter, int Cnt_Now, int SCF_iter, char fname[YOUSO10],
                   double ChemP_e0[2]);
void   init();
void   Find_CGrids(int Real_Position, int n1, int n2, int n3, double Cxyz[4], int NOC[4]);
...
void   Eigen_PReHH(MPI_Comm MPI_Current_Comm_WD, double ** ac, double * ko, int n, int EVmax, int bcast_flag);
void   Eigen_PHH(MPI_Comm MPI_Current_Comm_WD, dcomplex ** ac, double * ko, int n, int EVmax, int bcast_flag);
void BroadCast_ReMatrix(MPI_Comm MPI_Curret_Comm_WD, double ** Mat, int n, int * is1, int * ie1, int myid, int numprocs,
                        MPI_Status * stat_send, MPI_Request * request_send, MPI_Request * request_recv);
void BroadCast_ComplexMatrix(MPI_Comm MPI_Current_Comm_WD, dcomplex ** Mat, int n, int * is1, int * ie1, int myid,
                             int numprocs, MPI_Status * stat_send, MPI_Request * request_send,
...
void   spline3(double r, double r1, double rcut, double g, double dg, double value[2]);
void   Cswap(dcomplex * a, dcomplex * b);
void   fnjoint(char name1[YOUSO10], char name2[YOUSO10], char name3[YOUSO10]);
void   fnjoint2(char name1[YOUSO10], char name2[YOUSO10], char name3[YOUSO10], char name4[YOUSO10]);
...
void Generating_MP_Special_Kpt(/* input */
                               int atomnum, int SpeciesNum, double tv[4][4], double ** Gxyz, double * InitN_USpin,
                               double * InitN_DSpin, double criterion_geo, int SpinP_switch, int * WhatSpecies,
...
void Make_Comm_Worlds(MPI_Comm MPI_Current_Comm_WD, int myid0, int numprocs0, int Num_Comm_World, int * myworld1,
...
void Make_Comm_Worlds2(MPI_Comm MPI_Curret_Comm_WD, int myid0, int numprocs0, int Num_Comm_World, int * myworld1,
                       MPI_Comm * MPI_CommWD,  /* size: Num_Comm_World */
                       int *      Comm_World1, /* size: numprocs0 */
                       int *      NPROCS1_WD   /* size: Num_Comm_World */
);
...
void     ComplexSH(int l, int m, double theta, double phi, double SH[2], double dSHt[2], double dSHp[2]);
...
void DFTDvdW_init(int MD_iter);  /* okuno */
void DFTD3vdW_init(int MD_iter); /* Ellner */
...
int Matomnum, MatomnumF, MatomnumS, Max_Matomnum, Min_Matomnum;
...
double
    cncut_dftD; /* coordination number cut-off radius. Also needs global cut-off radius defined above (okuno) as rcut_dftD */
...
/* YTL-New-start */
double CDDF_Shift_ChemP; /* Shifted Chemical Potential */
int    CDDF_approach;
int    CDDF_printk; /* print k at n step in optical calculations */

/* for calcuating matrix elements of position = <a|r|b> */
double **** OLPpox;
double **** OLPpoy;
double **** OLPpoz;
...
/* broadcast H, S, and position matrix elements */
double *****H_all, *****iH_all;
double **** OLP_all;
double **** OLPpox_all;
double **** OLPpoy_all;
double **** OLPpoz_all;
void        broadcast_H_matrix_elements_to_all_processes(int myid0);        /* H matrix elements */
void        broadcast_Hnoncol_matrix_elements_to_all_processes(int myid0);  /* H matrix elements */
void        broadcast_S_matrix_elements_to_all_processes(int myid0);        /* S overlap matrix elements */
void        broadcast_Position_matrix_elements_to_all_processes(int myid0); /* position x/y/z matrix elements */
/* YTL-New-end */
...
/* at each thread */
void Calc_band_optical_col_1(double kx, double ky, double kz, int spin_index, int n, double * EIGEN, dcomplex ** H,
                             double * fd_dist, double ChemP);
void Calc_band_optical_noncol_1(double kx, double ky, double kz, int n, double * EIGEN, dcomplex ** H, double * fd_dist,
                                double ChemP);
...
double Band_DFT_Col_Optical_ScaLAPACK(int SCF_iter, int knum_i, int knum_j, int knum_k, int SpinP_switch,
                                      double ***** nh, double ***** ImNL, double **** CntOLP, double ***** CDM,
                                      double ***** EDM, double Eele0[2], double Eele1[2], int * MP, int * order_GA,
                                      double * ko, double * koS, double * H1, double * S1, double * CDM1, double * EDM1,
                                      dcomplex ** H);

double Band_DFT_NonCol_Optical(int SCF_iter, double * koS, dcomplex ** S, int knum_i, int knum_j, int knum_k,
                               int SpinP_switch, double ***** nh, double ***** ImNL, double **** CntOLP,
                               double ***** CDM, double ***** EDM, double Eele0[2], double Eele1[2]);

double Cluster_DFT_Optical(char * mode, int SCF_iter, int SpinP_switch, double *** Cluster_ReCoes, double ** Cluster_ko,
                           double ***** nh, double ***** ImNL, double **** CntOLP, double ***** CDM, double ***** EDM,
                           EXX_t * exx, dcomplex **** exx_CDM, double * Uexx, double Eele0[2], double Eele1[2]);

double Cluster_DFT_Optical_ScaLAPACK(char * mode, int SCF_iter, int SpinP_switch, double ** Cluster_ko, double ***** nh,
                                     double ***** ImNL, double **** CntOLP, double ***** CDM, double ***** EDM,
                                     EXX_t * exx, dcomplex **** exx_CDM, double * Uexx, double Eele0[2],
                                     double Eele1[2], int myworld1, int * NPROCS_ID1, int * Comm_World1,
                                     int * NPROCS_WD1, int * Comm_World_StartID1, MPI_Comm * MPI_CommWD1, int * is2,
                                     int * ie2, double * Ss, double * Cs, double * Hs, double * CDM1, int size_H1,
                                     int * SP_NZeros, int * SP_Atoms, double ** EVec1, double * Work1);
