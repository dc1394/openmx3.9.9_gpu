...
void Eigen_lapack(double ** a, double * ko, int n, int EVmax)
{
    ...
    do {
        ...
        if (solver_flag == 0)
            ...
            Eigen_cusolver_x(a, ko, n, EVmax);
        else if (solver_flag == 4)
            Eigen_cusolver_d(a, ko, n, EVmax);
        ...
        do {
            ...
            do {
                ...
                if (i == j && 0.00001 < fabs(sum - 1.0)) {
                    po = 1;
                } else if (i != j && 0.00001 < fabs(sum)) {
                    po = 1;
                }
...
#pragma acc data present(a[0 : n + 1][0 : n + 1])
#pragma acc data deviceptr(ko)
#pragma acc data create(b[0 : n + 1][0 : n + 1], sum)
    {
#pragma acc kernels
...
#pragma acc loop independent
            ...
            Eigen_cusolver_x_openacc(a, ko, n, EVmax);
...
void Eigen_lapack_x(double ** a, double * ko, int n0, int EVmax)
{
  ...
  fflush(stdout);
    ...
    F77_NAME(dsyevx, DSYEVX)
    (JOBZ, RANGE, UPLO, &n, A, &LDA, &VL, &VU, &IL, &IU, &ABSTOL, &M, ko, Z, &LDZ, WORK, &LWORK, IWORK, IFAIL, &INFO);
...
void Eigen_lapack_d(double ** a, double * ko, int n0, int EVmax)
{
  ...
  fflush(stdout);
    ...
    F77_NAME(dsyevd, DSYEVD)
    (JOBZ, UPLO, &n, A, &LDA, ko, WORK, &LWORK, IWORK, &LIWORK, &INFO);
...
void Eigen_lapack_r(double ** a, double * ko, int n0, int EVmax)
{
  ...
  fflush(stdout);
    ...
    F77_NAME(dsyevr, DSYEVR)
    (JOBZ, RANGE, UPLO, &n, A, &LDA, &VL, &VU, &IL, &IU, &ABSTOL, &M, ko, Z, &LDZ, ISUPPZ, WORK, &LWORK, IWORK, &LIWORK,
     &INFO);
...
void Eigen_HH(double ** ac, double * ko, int n, int EVmax)
{
    ...
    ***********************************************************************/
    ...
    double   ABSTOL = LAPACK_ABSTOL;
    double **ad, *D, *E, *b1, *u, *uu, *p, *q, *s, *c, s1, s2, s3, ss, u1, u2, r, p1, s20, s21, s22, s23, xsum, bunbo,
        si, co, sum, a1, a2, a3, a4, a5, a6, b7, x1, x2, xap, tmp1, tmp2, bb, bb1, ui, uj, uij;
    ...
    int jj, jj1, jj2, k, ii, ll, i3, i2, j2, i1s, i, j, i1, j1, n1, n2, ik, jk, po1, nn, count, ks;
...
void Eigen_HHQR(double ** ac, double * ko, int n, int EVmax)
{
    ...
    ***********************************************************************/
    ...
    double **ad, **aq, **b, *b1, *u, *uu, *p, *q, *s, *c, *ko1, s1, s2, s3, ss, u1, u2, r, p1, xsum, bunbo, si, co, sum,
        a1, a2, a3, a4, a5, a6, b7, r1, r2, r3, x1, x2, xap, tmp1, tmp2, bb, bb1, ui, uj, uij;

    int jj, jj1, jj2, k, ii, ll, i3, i2, j2, *jun, *shuku, *po, i, j, i1, j1, n1, n2, ik, jk, po1, nn, count;
...
static void Eigen_cusolver_x(double ** a, double * ko, int n0, int EVmax)
{
    ...
    */
    ...
    double * A = (double *)malloc(sizeof(double) * n0 * n0);
